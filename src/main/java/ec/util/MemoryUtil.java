...
public class MemoryUtil {
	...
	public MemoryUtil(byte nullReferenceSize, byte emptyObjectSize, byte emptyArrayVarSize) {
	...
	public static MemoryUtil forJRockitVM() {
		return new MemoryUtil((byte) 4, (byte) 8, (byte) 8);
	}

	public static MemoryUtil forSun32BitsVM() {
		return new MemoryUtil((byte) 4, (byte) 8, (byte) 4);
	}

	public static MemoryUtil forSun64BitsVM() {
		return new MemoryUtil((byte) 8, (byte) 16, (byte) 8);
	}

	public static MemoryUtil forDetectedVM() {
		return null;
	}
	...
	private List<ref> dedup = new ArrayList<>();
	...
	private static int sizeofPrimitiveClass(Class<?> clazz) {
		return clazz == boolean.class || clazz == byte.class ? 1
				: clazz == char.class || clazz == short.class ? 2 : clazz == int.class || clazz == float.class ? 4 : 8;
	}
